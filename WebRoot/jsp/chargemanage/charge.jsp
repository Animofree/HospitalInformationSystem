		...
		<div class="main-container container-fluid" style="z-index:3000;">
						...
						<div class="row-fluid">
							...
							<div class="span3" style="width:100%;">
								<div style="border-bottom:1px dotted #e2e2e2; margin-bottom:10px; width:96%;">
									<span style="margin-left:15px;">患者信息</span>
								</div>
								<div class="row-fluid">
									<div class="span4">
										<div class="control-group control-group-m">
			...
			<!-- -------------------------------------------------------------------------------------------------- -->	
						<div class="row-fluid">
							<div></div>
							<div style="border-bottom:1px dotted #e2e2e2; margin-bottom:10px; width:96%;">
									<span style="margin-left:15px;">收费信息</span>
							</div>
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="favorable" type="text" name="privilege"
											onkeyup="setfavorable()" />
									</div>
								</div>
							</div><!--/span-->
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="receivable" type="text" name="cost"
											readonly="readonly" />
									</div>
								</div>
							</div>
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="realitycharge" name="realitychargea" type="text"
											onkeyup="charge()" />
									</div>
								</div>
							</div>
							...
							<div class="span4" style="display:none">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="before" type="text" name="beforereceivable"
											readonly="readonly" />
									</div>
								</div>
								</div><!--/span-->
							<div class="span4" style="display:none">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="medicarepay" type="text" name="medicarecanpay"
											readonly="readonly" />
									</div>
								</div>
							</div>
