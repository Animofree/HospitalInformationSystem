			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						...
						<div class="span3">
							<div class="control-group control-group-m">
								<label class="control-label control-label-m">类型</label>
					...
					<div class="row-fluid">
						...
						<div class="span3">
							<div class="control-group control-group-m">
								<label class="control-label control-label-m">过敏史</label>
						...
						<div class="span3">
							...
							<label class="control-label control-label-m">挂号类型</label>
								<div class="controls controls-l" style="border:1px dotted #e2e2e2; max-width:294px; min-width:220px;" >
									...
									<select id="leixing" name="leixing" class="chzn-select" data-placeholder="-请选择-"
										onChange="registersum.value=parseInt(leixing.value);">
										<option id="opt" value="0" selected/>
										<option value="7" >普通</option>
										<option value="10">副高</option>
										<option value="25">正高</option>
										<option value="100">知名专家</option>
									</select>
					...
					<div class="row-fluid">
						<div></div>
						<div id="tableleft" class="span3" style="width:100%; overflow:auto; min-width:240px;">
